...
// =============================================================================
// /student/coach — Student Performance Coach
// -----------------------------------------------------------------------------
// Chat-style page that lets a student reflect on their own quiz performance
// and habits. Posts to /api/student/coach with the bearer token; appends each
    ...
    <div className="max-w-4xl mx-auto fade-in flex flex-col" style={{ minHeight: "calc(100vh - 4rem)" }}>
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="min-w-0">
          ...
          <h1 className="h1 flex items-center gap-2 mt-1">
            <MessageCircle size={28} /> Performance Coach
          </h1>
      ...
      <div className="mt-4 sticky bottom-0">
        ...
        <p className="muted text-xs mt-3 text-center">
          Your coach uses your data as of {snapshot ? relativeFromNow(snapshot.asOf) : "your last question"}.
          Always cross-check with your teacher before big decisions.
        </p>
      </div>
    </div>
  );
...
function EmptyState({
  ...
  return (
    <div className="card text-center py-10">
      ...
      <h2 className="text-lg font-semibold">Your study co-pilot</h2>
      <p className="muted text-sm mt-1 max-w-md mx-auto">
        I&rsquo;ve already pulled your last 30 days of attempts, your Bloom levels,
        and your strongest and weakest topics. Ask anything &mdash; I&rsquo;ll cite your numbers.
      </p>
